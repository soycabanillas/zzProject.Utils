...
namespace zzProject.Utils.Web.ContentNegotiation
{
    /// <summary>
    ...
    public sealed class QValueList : List<QValue>
    {
        ...
        public static QValueList Header_AcceptLanguage(System.Web.HttpRequest request)
        {
            return new QValueList(request.UserLanguages);
        }
    }
}
